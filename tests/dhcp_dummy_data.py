...
options = bytearray(b"c\x82Sc5\x01\x01\x0c\x12WIZnet040506070809\xff")
...
options = bytearray(b"c\x82Sc5\x01\x01\x0c\x04bert\xff")
...
options = bytearray(b"c\x82Sc5\x01\x01\x0c\x05clash\xff")
...
options = bytearray(
    b"c\x82Sc5\x01\x03\x0c\x12WIZnet4B3FA604C8657\x03\x01\x03"
    b"\x062\x04def\x046\x04\xf5\xa6\x05\x0b\xff"
)
